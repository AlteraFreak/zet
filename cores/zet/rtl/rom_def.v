...
`define EINT	9'b110010000
`define EINTP	9'b110011011
`define INTO	9'b110100110
`define IRET	9'b110110010
`define NOP	9'b110111001
`define CLC	9'b110111010
`define CLD	9'b110111011
`define CLI	9'b110111100
`define CMC	9'b110111101
`define HLT	9'b110111110
`define STC	9'b110111111
`define STD	9'b111000000
`define STI	9'b111000001
